...
public class Home03Test extends Base_Test {

	@Test
	public void HomePage_TestCase_03() throws Throwable {

		HomePage hp = new HomePage(driver);
		UtilityMethods um = new UtilityMethods();
		CommonUtility cu = new CommonUtility();
		um.clickAction(hp.restaurantsLink);
		// to click on view menu buttons
		...
		for (int i = 0; i < rp.viewMenuButton.size(); i++) {
			...
			um.clickAction(rp.viewMenuButton.get(i));
