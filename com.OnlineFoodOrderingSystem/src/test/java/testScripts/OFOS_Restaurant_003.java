...
public class OFOS_Restaurant_003 extends OFOS_Login_002 {

	@Test( )
	 public synchronized void testCase_003() {
		...
		//Click on the order now button of any Dish
				for(int i=0;i<itemCount;i++) {
					...
					test.log(LogStatus.INFO, "Clicking on order now button of "+home.getNameOfAllDishes().get(i).getText());
					...
					js.executeScript("arguments[0].scrollIntoView(true);", dish.getCheckoutButton());
